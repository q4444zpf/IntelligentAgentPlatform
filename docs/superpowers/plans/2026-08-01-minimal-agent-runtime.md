...
- [x] **Step 1: 写默认模型选择和 OpenAI-compatible 请求的失败测试**
...
Run: `git grep -n "runtime-secret" -- backend/app frontend/src`

Expected: 无格式错误，生产目录无测试密钥。
